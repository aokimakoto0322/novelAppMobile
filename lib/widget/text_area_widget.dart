...
class TextAreaWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TextAreaWidget> createState() => TextAreaWidgetState();
}

class TextAreaWidgetState extends ConsumerState<TextAreaWidget>
  ...
  void handleTap() {
    if (!_isTextFinished) {
      ...
      if (ref.read(storyUsecaseProvider).isDisplayingChoicePrompt) {
        ref.read(storyUsecaseProvider.notifier).displayChoiceScreen();
      }
    } else {
      widget.onTap?.call();
    }
